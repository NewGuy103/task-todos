...
class Ui_AddTaskDialog:
    ...
    def retranslateUi(self, AddTaskDialog):
        AddTaskDialog.setWindowTitle(QCoreApplication.translate("AddTaskDialog", "Task to-dos - Add task", None))
        self.subjectLabel.setText(QCoreApplication.translate("AddTaskDialog", "Subject:", None))
        self.deadlineLabel.setText(QCoreApplication.translate("AddTaskDialog", "Deadline:", None))
        self.deadlineDateTimeEdit.setDisplayFormat(
            QCoreApplication.translate("AddTaskDialog", "M/d/yy h:mm:ss\u202fAp", None)
        )
        self.taskLabel.setText(QCoreApplication.translate("AddTaskDialog", "Task:", None))
        self.categoryLabel.setText(QCoreApplication.translate("AddTaskDialog", "Category:", None))
