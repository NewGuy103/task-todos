...
def main():
    ...
    for root, _dirs, files in ui_files_dir.walk():
        ...
        subprocess.check_call(["uv", "run", "ruff", "check", "app/ui", "--fix"])  # noqa: S607
        subprocess.check_call(["uv", "run", "ruff", "format", "app/ui"])  # noqa: S607
